...
const HeaderDetail = ({ dataAlbum }) => {
  const imgAlbum = `${ALBUMS_URL}/${dataAlbum?.imagePath}`;

  return (
    <div className="w-full bg-linear-to-b from-blue_top/30 via-blue_top/10 to-transparent px-4 sm:px-6 lg:px-8 pt-6 pb-8 sm:pn-10">
